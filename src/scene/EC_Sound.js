...
function EC_Sound() {
    Tundra.Component.call(this, cComponentTypeSound);
...
EC_Sound.prototype = new Tundra.Component(cComponentTypeSound);

Tundra.registerComponent(cComponentTypeSound, "Sound", function(){ return new EC_Sound(); });
